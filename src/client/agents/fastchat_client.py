...
class FastChatAgent(AgentClient):
    ...
    def inference(self, history: List[dict]) -> str:
        ...
        if self.shared_memory:
            history = self.shared_memory.retrieve(self.__class__.__name__) + history
        ...
        if self.shared_memory:
            self.shared_memory.store(self.__class__.__name__, history)
